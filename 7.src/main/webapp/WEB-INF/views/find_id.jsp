...
<html lang="ko">
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/find_id.css" />
</head>
<body>
<%@include file ="header.jsp" %>
    ...
    >
      <div class="container text-center py-5">
        <h1 class="display-3 text-white mb-4 animated slideInDown">ID 찾기</h1>
      </div>
    </div>
    ...
    <main class="container" id="content">
      ...
      <form class="find_box">
        ...
        <div class="find_tel_box input_box_design">
          <label for="find_tel">전화번호&nbsp;&nbsp;&nbsp;</label>
          <input
            type="tel"
            name="find_tel"
            id="find_tel"
        ...
        <div class="find_button">
          <button type="submit" name="submit_button" id="submit_button">
            <a href="find_id_true.jsp">Search</a>
          </button>
        </div>
      </form>
    </main>
